...
public class LapPembelian extends javax.swing.JPanel {
    ...
    private void btnExportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExportMouseClicked
        try {
            ...
            InputStream in = this.getClass().getClassLoader().getResourceAsStream("./report/pembelian_report.jrxml");
    ...
    private void getData(String searchQuery) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String emailSuplier = rs.getString("email_suplier");
                String nomorTelpSuplier = rs.getString("nomor_telp_suplier");
                String alamatSuplier = rs.getString("alamat_suplier");
            ...
            Logger.getLogger(LapPembelian.class.getName()).log(Level.SEVERE, null, e);
        }
    }
}